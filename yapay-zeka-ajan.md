...
**Tanım / Örnek Senaryo**
Bugüne kadar dijital bankacılık sistemleri **API-first** mantığıyla kurgulandı: belirli bir işlem yapmak için kullanıcı doğru endpoint’i çağırmak zorundaydı. **Intent-first** yaklaşımında ise kullanıcı niyetini belirtir, sistem geri kalan işlemleri kendi başına orkestre eder. Müşteri örnekleri:
...
## **6. Dijital Finansal Takma Akıl (Co-Thinker)**
